...
class RandomWalk(nn.Moudle):
    ...
    def __init__(self, input_dim, max_step, hidden_graphs, size_hidden_graphs, 
        ...
        self.device = device
        self.adj_hidden = nn.Parameter(torch.FloatTensor(hidden_graphs, (size_hidden_graphs*(size_hidden_graphs-1))//2))
        self.features_hidden = nn.Parameter(torch.FloatTensor(hidden_graphs, size_hidden_graphs, hidden_dim))
