...
from ..RsData import LoadData as recData
from .rec_utils import BPRData
from ..metrics import *
...
class Trainer:
    ...
    def prepare_data(self):
        ...
        train_dataset = BPRData(train_data, self.train_matrix, True)
    ...
    def fit(self):
        ...
        if not os.path.exists('./saved/recommender/'):
            os.makedirs('./saved/recommender/', exist_ok=True)
        torch.save(self.model.state_dict(), './saved/recommender/' + 'LightGCN.pth')
